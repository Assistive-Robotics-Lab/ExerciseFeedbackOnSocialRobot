...
### ----- Draw functions -----
# Different functions available depending on the type of data available
...
### --- MAIN BLOCK ---
# This code reads frames from the camera, processes it, and sends results over flask. 
# It is not pretty
# Use functions people, please
...
### This is key for pose detection
mp_holistic = mp.solutions.holistic 
# More info at https://github.com/google/mediapipe/blob/master/docs/solutions/holistic.md


### FLASK server
movement_url = 'http://' + mediapipe_url + ':5000/movement'
demand_url = 'http://' + mediapipe_url + ':5000/demand'
counting_url = 'http://' + mediapipe_url + ':5000/counting'
heart_rate_url ='http://' + mediapipe_url + ':5000/heart_rate'
hr_url ='http://' + mediapipe_url + ':5000/hr'
...
with mp_holistic.Holistic(min_detection_confidence=0.5, min_tracking_confidence=0.5) as holistic:
 ...
 while cap.isOpened():
        ...
        ### Use mediapipe to get the pose of the subject, store in results
        ...
        # Using these results, lets process them        
        try:
            ...
            ### Left shoulder
            # Some of these calculations have already been done...
...
# Calculate the position coordinates relative to the new width and height
            ...
            # Check with the robot to see what exercise we are doing. 
            # "demand"" is the exercise or state of the robot (paused, for example). 
