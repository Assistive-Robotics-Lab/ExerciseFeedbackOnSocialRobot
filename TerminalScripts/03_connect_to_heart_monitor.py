...
# Use bluepy to interact with bluetooth devices ()the heart rate monitor)
# Use requests to interact with the erver
...
class VeritySenseSensor:
    def __init__(self, mac_address):
        ...
        ### KEY Line
        self.heart_rate_delegate = HeartRateDelegate() # Along with updating heartrate, this will also eventually 
