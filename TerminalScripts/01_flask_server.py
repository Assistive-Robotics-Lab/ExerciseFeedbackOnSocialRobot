...
# The following code starts a Flask server
# As usual, servers receive and send messages
# All functions here are a tiny part of the server, they trigger different actions in this server

# app.route() tells Flask the url to trigger
# So, if over the "/message" url we receive the GET parameter, send the corresponinding message above. 
# If we get POST, lets listen for the message and update a variable/parameter

# We use this variables to store values
message = ""
movement = ""
demand = ""
counting = ""
...
# Receive and update heartrate data 
